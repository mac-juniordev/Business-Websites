            ...
            >
                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-forest font-semibold">+1 (555) 123-4567</p>
                    </div>
                  </a>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-forest font-semibold">Chat with Us</p>
                    </div>
                  </a>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-forest font-semibold">info@noblepaws.com</p>
                    </div>
                  </a>
              ...
              <div className="bg-gold/10 rounded-2xl p-8 border border-gold/20">
                ...
                <p className="text-sm text-charcoal/60 mb-4">
                  Browse our available puppies and find your perfect companion.
                </p>
                <a
                  href="/dogs"
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-lg border border-forest/20 focus:border-forest focus:ring-2 focus:ring-forest/20 outline-none transition-all"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-lg border border-forest/20 focus:border-forest focus:ring-2 focus:ring-forest/20 outline-none transition-all resize-none"
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-forest text-white py-4 rounded-full font-semibold hover:bg-forest/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {loading ? (
                      'Sending...'
                    ) : (
